...
export function isBlogEntry(v: unknown): v is BlogEntry {
	return isObj(v) && hasProp(v, "$type") && v.$type === "com.whtwnd.blog.defs#blogEntry";
}
...
export function isComment(v: unknown): v is Comment {
	return isObj(v) && hasProp(v, "$type") && v.$type === "com.whtwnd.blog.defs#comment";
}
...
export function isOgp(v: unknown): v is Ogp {
	return isObj(v) && hasProp(v, "$type") && v.$type === "com.whtwnd.blog.defs#ogp";
}
...
export function isBlobMetadata(v: unknown): v is BlobMetadata {
	return isObj(v) && hasProp(v, "$type") && v.$type === "com.whtwnd.blog.defs#blobMetadata";
}
