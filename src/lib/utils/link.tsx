import { type AppBskyGraphDefs, AppBskyRichtextFacet, AtUri, RichText, UnicodeString } from "@atproto/api";
...
export function getStarterPackImage(starterPack: AppBskyGraphDefs.StarterPackView) {
	const rkey = new AtUri(starterPack.uri).rkey;
	return `https://ogcard.cdn.bsky.app/start/${starterPack.creator.did}/${rkey}`;
}

export function getStarterPackHref(starterPack: AppBskyGraphDefs.StarterPackViewBasic) {
	const rkey = new AtUri(starterPack.uri).rkey;
