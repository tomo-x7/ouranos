...
export default function Page(props: Props) {
	...
	return (
		<section className="flex flex-col gap-5">
					...
					<Popover.Root>
						...
						<Popover.Portal>
							<Popover.Content className="animate-fade animate-duration-200 outline-none border-skin-base bg-skin-base text-skin-base z-50 m-2 max-h-full min-w-fit overflow-y-auto rounded-xl border p-2 shadow-lg">
								<span className="text-skin-base font-semibold">Advanced Search</span>
								<p className="max-w-48 text-sm">You can finetune with these options</p>
								<div className="flex flex-col gap-3 mt-3">
									<div className="flex flex-col">
										<div className="flex items-center gap-2">
											<BsFillPeopleFill />
											<span className="text-skin-base font-medium mb-1">By user</span>
										</div>
									...
									<div className="flex flex-col">
										<div className="flex items-center gap-2">
											<FaCalendarAlt />
											<span className="text-skin-base font-medium mb-1">By date</span>
										</div>
										<ul className="text-skin-secondary text-sm">
											<li>
			...
			{!query && (
				<section>
					<h2 className="text-skin-base mb-2 px-3 text-2xl font-semibold md:px-0">Who to follow</h2>
					<WhoToFollowList />
				</section>
			)}
		</section>
