...
import type * as BlueLinkatBoard from "./types/blue/linkat/board";
import type * as ComWhtwndBlogEntry from "./types/com/whtwnd/blog/entry";
import type * as FyiUnravelFrontpagePost from "./types/fyi/unravel/frontpage/post";
