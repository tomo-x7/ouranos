...
export default function GifEmbed(props: Props) {
	...
	return (
		<div onClick={togglePlayPause} className="w-fit relative cursor-pointer rounded-md group">
			<video
				ref={videoRef}
				src={embed.url}
				...
				className={`rounded-md group-hover:brightness-90 ${isLoading ? "opacity-0" : "opacity-100"}`}
			/>
