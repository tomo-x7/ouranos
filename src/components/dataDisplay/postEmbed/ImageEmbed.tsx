...
export default function ImageEmbed(props: Props) {
	...
	const generateImageLayout = (count: number, images: AppBskyEmbedImages.ViewImage[]) => {
	...
	return (
		<>
			...
			{depth < 2 && <article className="mt-2">{generateImageLayout(imageCount, content.images)}</article>}
		</>
	);
}
