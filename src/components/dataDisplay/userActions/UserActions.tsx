...
export default function UserActions(props: Props) {
	...
	return (
		<Dropdown>
			...
			<Dropdown.Menu>
				<Dropdown.MenuItem onSelect={handleShare} text="Copy Link to Profile" icon={<BiLink />} />

				<Dropdown.MenuItem onSelect={handleSearch} text="Search Posts" icon={<PiMagnifyingGlassBold />} />
