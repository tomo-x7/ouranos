			...
			<div>
					...
					<div className="border-skin-base mt-3 flex flex-wrap items-center gap-3 border-y py-2">
						{repostCount > 0 && (
							...
							>
								...
								<span className="text-skin-tertiary font-medium">Repost{repostCount > 1 && "s"}</span>
							</Link>
						)}
						{quoteCount > 0 && (
							<Link
							...
							>
								...
								<span className="text-skin-tertiary font-medium">Quote{quoteCount > 1 && "s"}</span>
							</Link>
						)}
						{likeCount > 0 && (
							<Link
							...
							>
								...
								<span className="text-skin-tertiary font-medium">Like{likeCount > 1 && "s"}</span>
							</Link>
						)}
					</div>
				)}
				<div className="mt-3 flex justify-between">
					...
					<Button
						...
						className={liked ? "text-skin-icon-like" : "text-skin-icon-muted hover:text-skin-icon-like"}
					>
						{liked ? <BiSolidHeart className="text-xl" /> : <BiHeart className="text-xl" />}
					</Button>
					<Dropdown>
						<Dropdown.Trigger>
							<Button
						...
						<Dropdown.Menu>
							...
							<Dropdown.MenuItem onSelect={handleShare} text="Copy Link to Post" icon={<MdIosShare />} />
							{text && (
								<Dropdown.MenuItem
	...
	return (
		<div className="flex justify-between">
			...
			<Dropdown>
              ...
              ${reposted ? "text-skin-icon-repost" : "text-skin-icon-muted hover:text-skin-icon-repost"}
            `}
					>
			...
			<Button
				...
				className={`text-sm font-medium ${
					liked ? "text-skin-icon-like" : "text-skin-icon-muted hover:text-skin-icon-like"
				}
          `}
			>
				{liked ? <BiSolidHeart className="text-lg" /> : <BiHeart className="text-lg" />}
