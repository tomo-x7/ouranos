...
export default function BottomEditorBar(props: Props) {
	...
	return (
		<section>
			...
			<div className="border-skin-base border-t">
				<div className="flex flex-wrap justify-between gap-5 mt-3">
					...
					<div className="just flex flex-wrap gap-x-5 gap-y-2">
						<LanguagePicker languages={languages} onSelectLanguages={onSelectLanguages} />
            ...
            ${isDragActive && "ring-primary border-skin-base bg-skin-secondary ring-2"}
          `}
				>
					<input {...getInputProps()} />
						...
						<>
							{!isDragReject && (
								<span className="text-skin-base">
									Drag and drop your images or click to select images <br /> You can upload up to 4
									images
								</span>
							)}
							{isDragReject && <span className="text-skin-base">You cannot upload this file type</span>}
						</>
					</div>
				</div>
			)}
