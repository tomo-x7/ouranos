	...
	return (
		<article ref={threadPostRef}>
			<div className="relative flex items-start gap-3">
				...
				>
					<ProfileHoverCard handle={author.handle}>
						<Avatar src={author.avatar?.replace("avatar", "avatar_thumbnail")} size="md" />
					</ProfileHoverCard>
				</button>
			...
			<div className="mt-3">
				...
				<div className="text-sm text-skin-tertiary mt-3 font-medium">{getFormattedDate(post.indexedAt)}</div>
			</div>
