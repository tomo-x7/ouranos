...
export default function FeedHeader(props: Props) {
	const { list } = props;
	const { listInfo, isLoadingListInfo, isFetchingListInfo, isRefetchingListInfo, listInfoError } = useListInfo(list);
			...
			<div className="flex flex-wrap items-center justify-between gap-3">
				<div className="flex flex-wrap items-center gap-3">
					...
					<div className="flex flex-col">
						<h2 className="text-skin-base break-words text-xl font-semibold">{listInfo.list.name}</h2>
