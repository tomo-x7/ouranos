...
export default function FeedTabs() {
	...
	return (
		<>
			...
			<div
				className={
					"bg-skin-base border-skin-base sticky top-[3.2rem] z-50 overflow-x-hidden border-x-0 border-b border-t-0 transition-all ease-linear hover:overflow-x-auto md:top-6 md:z-50 md:rounded-t-2xl md:border md:opacity-100"
				}
				style={{
