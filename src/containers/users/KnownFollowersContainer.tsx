...
export default function KnownFollowersContainer(props: Props) {
	...
	const isEmpty = !isFetchingKnownFollowers && !isFetchingKnownFollowersNextPage && dataLength === 0;
	...
	return (
		<section>
			...
			{isFetchingKnownFollowers && !isFetchingKnownFollowersNextPage && <ProfileCardSkeleton />}
			{isEmpty && (
				<div className="mx-3 md:mx-0">
					<FeedAlert variant="empty" message={`${handle} has no known followers... yet`} standalone />
				</div>
			)}
		</section>
	);
