...
export default function MutedUsersContainer() {
	...
	const dataLength = profiles?.pages.reduce((acc, page) => acc + (page?.mutes.length ?? 0), 0);
	...
	return (
		<>
			<h2 className="text-skin-base mx-3 mb-2 text-2xl font-semibold md:mx-0">Muted Users</h2>
			<section className="mt-2 flex flex-col">
				...
				{isEmpty && (
					<div className="mx-3 md:mx-0">
						<FeedAlert variant="empty" message="You have not muted any users... yet" standalone={true} />
					</div>
				)}
			</section>
		</>
